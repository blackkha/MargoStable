#!/usr/bin/env python
"""
Specialized script for running only the Telegram bot
This script breaks any potential circular imports that might lead to
initializing Flask app twice.
"""
import os
import sys
import logging
...
# This is the complete implementation of the bot,
# to ensure no imports from app.py or other Flask-related files
def run_telegram_bot():
    ...
    # Cached data
    cached_data = "Data not loaded yet."
    ...
    def get_sample_data():
        ...
        sample_data = [
            {"symbol": "SOL", "borrow_amount": 800853137.0, "repay_amount": 10000000.0, "ratio": 80.08},
            {"symbol": "USUAL", "borrow_amount": 209567041.0, "repay_amount": 5000000.0, "ratio": 41.91},
            {"symbol": "ALPACA", "borrow_amount": 256490630.0, "repay_amount": 60300000.0, "ratio": 4.25},
            {"symbol": "BSW", "borrow_amount": 144148131.0, "repay_amount": 104000000.0, "ratio": 1.39},
            {"symbol": "INIT", "borrow_amount": 785296364.0, "repay_amount": 915000000.0, "ratio": 0.86},
            {"symbol": "MEMEFI", "borrow_amount": 120259078.0, "repay_amount": 178000000.0, "ratio": 0.68},
            {"symbol": "LEVER", "borrow_amount": 111266502.0, "repay_amount": 172000000.0, "ratio": 0.65},
            {"symbol": "ARDR", "borrow_amount": 465429252.0, "repay_amount": 1103000000.0, "ratio": 0.42},
            {"symbol": "RDNT", "borrow_amount": 115068714.0, "repay_amount": 274000000.0, "ratio": 0.42},
            {"symbol": "HYPER", "borrow_amount": 106835701.0, "repay_amount": 358000000.0, "ratio": 0.30}
        ]
        return sample_data
    ...
    def fetch_margin_data():
        ...
        try:
            ...
            try:
                # This will use the externally accessible Replit URL or localhost
                logger.info("Trying to fetch data from web application API")
                
                # Get the Replit domain from environment or use localhost
